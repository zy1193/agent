...
<html>
 ...
 <body>
  <form name="queryform" namespace="/aop" action="acctloglist.action" >
  <div class="right_box">
  	<div id="titlediv">
  		<table>
  			<tr>
  				<th></th>
  				<th>代理商ID</th>
  				<th><input class="required ipb_s" type='text' name='acctId' id='acctId' value='${acctId!""}' /></th>
  				<th>交易日期</th>
  				<th><input class="required ipb_s" type="text" name='dateStart' id="dateStart" value="${dateStart!""}"/></th>
  				<th>到<input class="required ipb_s" type="text" name='dateEnd' id="dateEnd" value="${dateEnd!""}"/></th>
  				<th>交易类型</th>
